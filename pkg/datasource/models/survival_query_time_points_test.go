...
func TestExpansion(t *testing.T) {
	...
	var timePoints = timePointsFromTable([][]int64{{1, 1, 0}, {5, 1, 0}, {13, 2, 5}})
	var timePointsExpanded = timePointsFromTable([][]int64{{0, 0, 0}, {1, 1, 0}, {2, 0, 0}, {3, 0, 0}, {4, 0, 0}, {5, 1, 0}, {6, 0, 0}, {7, 0, 0}, {8, 0, 0}, {9, 0, 0}, {10, 0, 0}, {11, 0, 0}, {12, 0, 0}, {13, 2, 5}, {14, 0, 0}})

	res, err := timePoints.Expand(15, "notATimeResolution")
	assert.Error(t, err)
	res, err = timePoints.Expand(15, "day")
	if err != nil {
		t.Error(err)
	}
...
// timePointsFromTable is a testing helper function that builds a TimePoints instance from a 2D int array.
		...
		res[i] =
			TimePoint{Time: point[0],
				Events: struct {
					...
					EventsOfInterest: point[1],
					CensoringEvents:  point[2],
				},
			}
